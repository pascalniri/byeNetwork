...
const Offers = () => {
  ...
  return (
    <motion.div
      ...
      whileInView="visible"
      viewport={{ amount: 0.2 }}
      className='font-montserrat bg-[#FAFAFA] flex flex-col justify-center items-center py-[4rem] text-center max-w-screen-2xl mx-auto px-4 md:px-[5rem] lg:px-[6rem] lg:mt-[13rem] mt-[5rem] bg-[url("/transparent.svg")] bg-no-repeat h-full w-full'
    >
