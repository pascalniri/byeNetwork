  ...
  return (
    <div className='bg-black text-white font-poppins py-[50px] overflow-hidden'>
      <div className='mx-auto px-4 md:w-[80%] flex flex-col justify-center items-center'>
          <h1 className='text-[40px] font-extralight text-[#6A402F]'><span className='font-semibold'>Contact</span> Information</h1>
          ...
          <span className='flex flex-col hover:text-[#c26f4e] hover:scale-110 transition text-center justify-center items-center gap-1 cursor-pointer'>
