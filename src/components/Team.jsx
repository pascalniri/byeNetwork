      ...
      <div className="w-full md:max-w-2xl lg:max-w-6xl xl:px-0 mx-auto p-4 mt-[150px] font-outfit text-light">
        ...
        {activeTab === "videos" ? (
          <div>
            ...
            <h1 className="font-bold text-[40px] md:text-[60px] relative inline-block after:content-[''] after:absolute after:left-1/2 after:bottom-0 after:w-1/2 after:border-b-2 after:border-black mt-[50px]">
              Support Team
            </h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[20px] my-[50px]">
