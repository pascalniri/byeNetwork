...
const Join = () => {
  ...
  return (
    <div className="font-montserrat flex flex-col justify-center items-center pt-[4rem]  text-center max-w-screen-2xl mx-auto lg:mt-[5rem] mt-[5rem]">
      <Fade
        triggerOnce={false}
        className="lg:text-[44px] lg:leading-[44px] font-bold text-[30px] leading-[35px]"
      >
      ...
      <div className="relative flex justify-center">
        ...
        whileInView="visible"
        viewport={{  amount: 0.2 }}
        className="hidden absolute px-4 md:px-[5rem] lg:px-[10rem] -top-[8rem] lg:grid grid-cols-1 lg:grid-cols-2 gap-5 justify-items-center">
          {joins.map((join, index) => (
            <div
              key={index}
              className="bg-white rounded-lg border-b-[10px] border-[#693e2d] shadow-2xl px-[2rem] py-[3rem] flex flex-col items-start text-left justify-center"
            >
