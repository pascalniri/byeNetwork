...
const leaders: Leader[] = [
  ...
  },
  {
    ...
    department: "Executive Leadership",
    longBio:
      "James Brazzell is a sophomore at Morehouse College majoring in Business Administration. As Deputy Executive Director of BYEN, he is dedicated to empowering youth through leadership and service, and is committed to building strong communities and expanding opportunities for young Black leaders.",
    empowermentQuote: "",
    achievements: [
    ...
    gallery: ["/james.jpg", "/IMG_7588 - Black Youth Empowerment Network.jpeg"],
  },
  {
    id: "khalil-jackson",
    ...
    department: "Executive Leadership",
    longBio:
      "Khalil Jackson is a first-year graduate student at Emory University, having graduated from Clark Atlanta University in 2025 with a degree in Political Science. As Director of Strategic Initiatives and Policy for BYEN, he brings extensive experience in public policy, community development, and leadership.",
    empowermentQuote: "",
    achievements: [
    ...
    education:
      "Clark Atlanta University ('25), Emory University - First year graduate student, Political Science",
    socialMedia: {
      ig: "https://www.instagram.com/jackson.khalil?igsh=MWh5dmczZWoybzkwcA%3D%3D&utm_source=qr",
      x: "N/A",
      linkedIn:
        "https://www.linkedin.com/in/khalil-jackson-248881225?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
      facebook: "N/A",
  ...
  },
  {
    ...
    socialMedia: {
      ...
      x: "N/A",
      linkedIn:
        "https://www.linkedin.com/in/isaac-banks-smith?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
      facebook: "N/A",
  ...
  },
  {
    ...
    name: "Jibri Wright",
    title: "Manager of Partnerships and Special Projects",
    status: "director",
    department: "Programming & Events",
    longBio:
      "Jibri Wright is a junior at Morehouse College majoring in Business Finance. As Manager of Partnerships and Special Projects for BYEN, he brings his entrepreneurial spirit and commitment to community service to lead impactful programming and events.",
    empowermentQuote: "",
    achievements: [
    ...
    gallery: ["/IMG_0386 - Jibri Wright.jpeg"],
  },
  {
    id: "olivia-robinson",
    ...
    achievements: [
      ...
      "Youth Mentor/ Workshop Facilitator",
      "International Baccalaureate Diploma Recipient",
    ],
    education: "Spelman College, Rising- Sophomore, Health Science (Pre-Med)",
    socialMedia: {
      ig: "https://www.instagram.com/livirobin83?igsh=NmY3aTc4eDVkcjBn&utm_source=qr",
      x: "N/A",
      linkedIn:
        "https://www.linkedin.com/in/olivia-robinson-6240162b8?utm_source=share_via&utm_content=profile&utm_medium=member_ios",
      facebook: "N/A",
      email: "olivia@wearebyen.org",
    },
    gallery: [
      "/AEBA149A-ED58-4696-92DB-4C70884761CC - Olivia Robinson.png",
      "/IMG_4974 - Olivia Robinson.jpeg",
    ],
  },
  {
    id: "jordan-fischer",
    image: "/Jordan Fischer Headshot - Jordan Fischer.PNG",
    name: "Jordan Fischer",
    title: "Director of Policy and Civic Engagement",
    status: "director",
    ...
    achievements: [
      ...
      "Selected as a Morgan Stanley HBCU Scholar at Spelman College",
      "Received the NAACP National Playwriting Award",
    ],
    education: "Spelman College, Sophomore, Political Science",
    socialMedia: {
      ig: "https://instagram.com/jordannfischer",
      x: "N/A",
      linkedIn: "https://linkedin.com/in/jordanbfischer",
      facebook: "N/A",
      email: "jordan@wearebyen.org",
    },
  ...
  },
  {
    ...
    achievements: [
      ...
      "DevCon Selection",
      "Brand & Operations Intern under BlackStone Launchpad and DivInc.",
    ],
    education: "Morehouse College, Sophomore, Business Admin",
    socialMedia: {
      ig: "https://www.instagram.com/imweak.alex?igsh=dWQ3Y29ndmhzYXhw&utm_source=qr",
      x: "N/A",
      linkedIn:
        "https://www.linkedin.com/in/alex-chambers-b80162274?utm_source=share_via&utm_content=profile&utm_medium=member_ios",
      facebook: "N/A",
      email: "Alex@wearebyen.org",
    },
    gallery: [
      "/IMG_4356 - Alex Chambers.jpeg",
      "/IMG_2875 - Alex Chambers.jpeg",
    ],
  },
  {
    id: "ivan-walker",
    image: "/IMG_5770 - Ivan Walker.jpeg",
    name: "Ivan Walker",
    title: "Director of Community Safety & Advocacy",
    status: "director",
    department: "Policy",
    longBio:
      "Ivan Walker is a Sophomore at Morehouse College majoring in Political Science. As Director of Community Safety & Advocacy, he focuses on developing initiatives that empower youth through violence prevention and strategic advocacy.",
    empowermentQuote: "",
    achievements: [
      "Founded Full Ride Family (FRF) – Established a Morehouse student organization focused on service, mentorship, and community impact.",
      "Director of Community Safety & Advocacy, BYEN – Created and lead the Young Black & Safe Initiative to educate and empower youth through violence prevention and advocacy.",
      "Chief of Staff, Morehouse Students Demand Action – Led campus organizing, member recruitment, and legislative advocacy for gun violence prevention.",
      "Michael L. Lomax Scholar, Morehouse College – Selected for a prestigious leadership scholarship recognizing academic achievement, service, and leadership potential.",
    ],
    education: "Morehouse College, Sophomore, Political Science",
    socialMedia: {
      ig: "https://www.instagram.com/ivanxgeez?igsh=MTl2dm16azdkb3Y5Yw%3D%3D&utm_source=qr",
      x: "N/A",
      linkedIn:
        "https://www.linkedin.com/in/ivan-walker-874893229?utm_source=share_via&utm_content=profile&utm_medium=member_ios",
      facebook: "https://www.facebook.com/share/1BMFccVsK9/?mibextid=wwXIfr",
      email: "icw547@gmail.com",
    },
    gallery: [
      "/IMG_8751 - Ivan Walker.jpeg",
      "/IMG_8506 - Ivan Walker.jpeg",
      "/IMG_5770 - Ivan Walker.jpeg",
      "/FA415FB4-E4D3-442B-B9EC-B86679A1DDE4 - Ivan Walker.jpeg",
