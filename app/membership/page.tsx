    ...
    <div className="font-montserrat">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 justify-items-center">
          {whyUs.map((us) => (
            ...
            >
              ...
              <p className="text-[13px] text-[#6C6A6A] md:w-[80%] mx-auto mt-2">{us.p}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center items-center max-w-screen-2xl mx-auto px-4 md:px-[5rem] lg:px-[6rem] py-[6rem]">
        ...
        <div className="mt-16 w-full">
          <h2 className="text-[28px] font-bold text-center mb-8">
            Choosing Your <span className="text-[#693e2d]">Path</span>
          </h2>
