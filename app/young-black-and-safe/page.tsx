...
export default function YoungBlackAndSafe() {
  return (
    <div className="font-montserrat">
      <div className="bg-[#FAFAFA] flex flex-col justify-center items-center py-[4rem] text-center max-w-screen-2xl mx-auto px-4 md:px-[5rem] lg:px-[6rem] bg-[url('/transparent.svg')] bg-no-repeat h-full w-full mt-[9rem]">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a href="#partner" className="relative text-[15px] text-white bg-gradient-to-r from-[#693e2d] to-[#985b3c] rounded-full py-3 px-8 hover:from-[#985b3c] hover:to-[#693e2d] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 overflow-hidden group">
            <span className="relative z-10 flex items-center font-medium">Partner With Us</span>
          ...
          <a href="#join" className="relative text-[15px] text-[#693e2d] bg-white border-2 border-[#693e2d] rounded-full py-3 px-8 hover:bg-[#693e2d] hover:text-white transition-all duration-300 shadow-lg transform hover:scale-105 overflow-hidden group">
            <span className="relative z-10 flex items-center font-medium">Join the Initiative</span>
          </a>
        </div>
      </div>
      ...
      <div className="bg-white max-w-screen-xl mx-auto px-4 md:px-8 py-16">
        <section className="mb-20">
          <h2 className="text-[24px] md:text-3xl font-bold text-[#693e2d] mb-6 border-b-2 border-[#985b3c] inline-block pb-2">
            Overview
          </h2>
        ...
        <section className="mb-20">
          ...
          <p className="text-[15px] leading-[20px] text-[#6C6A6A] mb-8 font-medium">
            ...
            <div className="mt-8">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <li className="flex items-start">
                  <span className="mr-3 font-bold text-xl">•</span> Increase access to practical safety information and resources
                </li>
                <li className="flex items-start">
                  <span className="mr-3 font-bold text-xl">•</span> Strengthen youth knowledge of legal rights and public systems
                </li>
                <li className="flex items-start">
                  <span className="mr-3 font-bold text-xl">•</span> Expand youth participation in community safety and policy discussions
                </li>
                <li className="flex items-start">
                  <span className="mr-3 font-bold text-xl">•</span> Support prevention, healing, and community-based intervention
                </li>
                <li className="flex items-start">
                  <span className="mr-3 font-bold text-xl">•</span> Build stronger relationships between young people and trusted institutions
                </li>
                <li className="flex items-start">
                  <span className="mr-3 font-bold text-xl">•</span> Position Black youth as informed contributors to long-term solutions
                </li>
              </ul>
            </div>
          </div>
        ...
        <section id="join" className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 flex-wrap">
            <a href="#" className="text-[15px] text-white bg-gradient-to-r from-[#693e2d] to-[#985b3c] rounded-full py-3 px-6 hover:shadow-lg transition-shadow">
              Join Young, Black, and Safe
            </a>
            <a href="#" className="text-[15px] text-[#693e2d] bg-white border border-[#693e2d] rounded-full py-3 px-6 hover:bg-gray-50 transition-colors">
              Partner With BYEN
            </a>
            <a
              ...
              className="text-[15px] text-gray-700 bg-gray-100 rounded-full py-3 px-6 hover:bg-gray-200 transition-colors"
            >
