...
const Section = ({
  ...
  return (
    ...
    >
      {title && <h2 className="text-3xl md:text-4xl font-bold mb-6 text-[#693e2d]">{title}</h2>}
      <div className="space-y-4 text-[#6C6A6A] leading-relaxed">{children}</div>
    </motion.section>
  );
};
...
export default function HistoryAndBackground() {
  return (
    <div>
      <div className="font-montserrat bg-[#FAFAFA] flex flex-col justify-center items-center py-[3rem] text-center max-w-screen-2xl mx-auto px-4 md:px-[5rem] lg:px-[6rem] bg-[url('/transparent.svg')] bg-no-repeat h-full w-full my-[9rem]">
              ...
              <div className="mt-8 space-y-8">
                <TimelineItem year="Early 2024" title="The Beginning">
                  <p className="text-[15px] leading-[20px] mt-4 text-[#6C6A6A]">
                    BYEN starts as an informal group chat, connecting passionate young individuals across the nation.
                  </p>
                </TimelineItem>

                <TimelineItem year="Summer 2024" title="Strategic Pause">
                  <p className="text-[15px] leading-[20px] mt-4 text-[#6C6A6A]">
                    Recognizing the need for stronger infrastructure, BYEN takes a temporary pause to restructure and rebuild.
                  </p>
                </TimelineItem>

                <TimelineItem year="Spring 2025" title="The Relaunch">
                  <p className="text-[15px] leading-[20px] mt-4 text-[#6C6A6A]">
                    Partnering with James Brazzell and supported by the AUC community, BYEN relaunches with a clear vision and structure.
                  </p>
                </TimelineItem>

                <TimelineItem year="Present" title="National Impact">
                  <p className="text-[15px] leading-[20px] mt-4 text-[#6C6A6A]">
                    With over 200 members across 25 states, BYEN continues to grow and empower Black youth nationwide.
                  </p>
                </TimelineItem>
              </div>
            </Section>
            ...
            <div className="bg-gradient-to-br from-[#f9f5f3] to-white p-6 rounded-xl shadow-lg sticky top-28">
              ...
              <ul className="space-y-4">
                <li className="flex items-center">
                  <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-[#693e2d] text-white text-sm font-bold mr-3 flex-shrink-0">
                    1
                  </span>
